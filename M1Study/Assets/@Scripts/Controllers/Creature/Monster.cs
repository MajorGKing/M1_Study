...
public class Monster : Creature
{
	...
	public override void OnDead(BaseObject attacker, SkillBase skill)
	{
		...
		Data.RewardData rewardData = GetRandomReward();
		if (rewardData != null)
		{
	...
	private Data.RewardData GetRandomReward()
	{
		if (MonsterData == null)
			return null;

		if (Managers.Data.DropTableDic.TryGetValue(MonsterData.DropItemId, out Data.DropTableData dropTableData) == false)
			return null;	
		...
		foreach (Data.RewardData item in dropTableData.Rewards)
		{
