...
public class QuestManager
{
	...
	{
		foreach (Data.QuestData questData in Managers.Data.QuestDic.Values.ToList())
		{
    ...
    void OnHandleBroadcastEvent(Define.EBroadcastEventType eventType, int value)
	{
		foreach (Quest quest in AllQuests.Values)
		{
			if (quest.State == Define.EQuestState.Processing)
